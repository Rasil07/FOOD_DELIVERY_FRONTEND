...
export const DELETE_ALL_ORDER_REQUEST = "DELETE_ALL_ORDER_REQUEST";
export const DELETE_ALL_ORDER_FAILURE = "DELETE_ALL_ORDER_FAILURE";
...
//Khalti Payment message types

export const ON_PAYMENT_SUCCESS = "ON_PAYMENT_SUCCESS";
export const ON_PAYMENT_FAILURE = "ON_PAYMENT_FAILURE";
export const ON_PAYMENT_CLOSE = "ON_PAYMENT_CLOSE";
